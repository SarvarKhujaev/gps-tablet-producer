...
import com.ssd.mvd.gpstracker.database.KafkaConsumer;
...
public class Trackers {
    ...
    public Trackers ( String pasportSeries ) {
        this.topicName = pasportSeries; // id of patrul who is using this tracker
