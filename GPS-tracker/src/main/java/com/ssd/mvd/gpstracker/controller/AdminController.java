...
public class AdminController {
    ...
    public Mono< ApiResponseModel > setTime ( Long time ) {
        ...
        return Mono.just( ApiResponseModel.builder().status( Status.builder().message( "Time for timer was established as: " ).code( 200 ).build() ).build() );
    }
    ...
    public Mono< ApiResponseModel > setTime ( Integer start, Integer end ) {
        ...
        return Mono.just( ApiResponseModel.builder().status( Status.builder().message( "Time for evening was established" ).code( 200 ).build() ).build() );
    }
    ...
    public Mono< ApiResponseModel > setTimeForMorning ( Integer start, Integer end ) {
        ...
        return Mono.just( ApiResponseModel.builder().status( Status.builder().message( "Time for morning was established" ).code( 200 ).build() ).build() );
    }
}
